        ...
        <form className="space-y-4" onSubmit={handleSave}>
          <div>
            ...
            {errors.name_claimant && (
              <p style={{ color: "darkgrey" }}>{errors.name_claimant}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.cedula_claimant && (
              <p style={{ color: "darkgrey" }}>{errors.cedula_claimant}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.cellphone_claimant && (
              <p style={{ color: "darkgrey" }}>{errors.cellphone_claimant}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.name_transmiter && (
              <p style={{ color: "darkgrey" }}>{errors.name_transmiter}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.surname_transmiter && (
              <p style={{ color: "darkgrey" }}>{errors.surname_transmiter}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.celphone_transmiter && (
              <p style={{ color: "darkgrey" }}>{errors.celphone_transmiter}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.address_transmiter && (
              <p style={{ color: "darkgrey" }}>{errors.address_transmiter}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            {errors.name_receiver && (
              <p style={{ color: "darkgrey" }}>{errors.name_receiver}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            />
            {errors.celphone_receiver && (
              <p style={{ color: "darkgrey" }}>{errors.celphone_receiver}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.address_receiver && (
              <p style={{ color: "darkgrey" }}>{errors.address_receiver}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            />
            {errors.weight && (
              <p style={{ color: "darkgrey" }}>{errors.weight}</p>
            )}
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
          ...
          <div>
            ...
            {errors.declared_value && (
              <p style={{ color: "darkgrey" }}>{errors.declared_value}</p>
            )}
          </div>
          ...
          <div>
            ...
            {actualBackOrder.product_image && (
              <img
                src={actualBackOrder.product_image}
                alt="product_image"
