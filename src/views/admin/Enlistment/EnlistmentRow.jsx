...
const EnlistmentRow = ({
  ...
  return (
    <tr>
      ...
      <td className="px-6 py-4 whitespace-nowrap">
        {enlistment.order && enlistment.order.name_claimant}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
        {enlistment.order && enlistment.order.cellphone_claimant}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
        {enlistment.order && enlistment.order.address_transmiter}
      </td>
      <td className="px-6 py-4 whitespace-nowrap">
        {enlistment.order && enlistment.order.address_receiver}
      </td>
