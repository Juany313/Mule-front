...
const ConfirmEmail = () => {
    ...
    useEffect(() => {
        ...
        if (verificationCode) {
            axios.get('http://localhost:3000/users/email-confirmation', {
                headers: {
    ...
    return (
            ...
            <div className="flex items-center justify-center min-h-screen p-5 bg-p300 min-w-screen">
                <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                    ...
                    <div className="mt-4">
                        <button className="px-2 py-2 text-white font-semibold bg-blue-600 rounded"
