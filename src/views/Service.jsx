  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-8">
        <div className={`bg-white rounded-xl shadow-lg ${prefersDarkMode ? '' : ''}`}>
          <div className={`max-w-sm px-6 border border-gray-200 rounded-lg shadow ${prefersDarkMode ? 'bg-white border-gray-200' : 'bg-white border-gray-700 dark:bg-gray-800 dark:border-gray-700'}`}>
