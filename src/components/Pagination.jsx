    ...
    <div>
      ...
      <div>
        <div className="flex justify-center gap-4 mt-4">
          <button
            className="bg-p300 hover:bg-p500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            onClick={prevPage}
          ...
          <button
            className="bg-p300 hover:bg-p500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            onClick={nextPage}
            disabled={indexOfLastCard >= allOrders.length}
          >
            Siguiente
          </button>
        </div>
