          ...
          <div className="flex justify-between">
            ...
            {step < 4 ? (
              ...
              <button
                ...
                className={`${
                  validateStep(step)
                    ? "bg-s300 hover:bg-s500 w-full ml-7"
                    : "bg-gray-500 w-full cursor-not-allowed ml-7"
                } text-white uppercase font-bold text-sm py-3 px-4 rounded-lg transition-colors`}
                disabled={!validateStep(step)}
                // className="bg-s300 text-black uppercase font-bold text-sm ml-2 w-full py-3 px-4 rounded-lg hover:text-gray-100 transition-colors"
              >
                Pagar
              </button>
            )}
